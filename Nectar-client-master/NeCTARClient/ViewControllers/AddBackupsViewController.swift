...
// Create a backup for a database instance according to the parameters provided by the user
class AddBackupsViewController: BaseViewController, UIPickerViewDelegate, UITextFieldDelegate{
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = "Create backup for "+instanceName
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(returnBack), name: "Backup created", object: nil)
    ...
    func createClick() {
        ...
        if let user = UserService.sharedService.user{
            ...
            NeCTAREngine.sharedEngine.createBackup(user.databaseServiceURL, name: nametext, instanceId: self.instanceId, descrip: descriptext!, token: user.tokenID).then{
                ...
                let alert = UIAlertController(title: "Backup Success", message: msg, preferredStyle: UIAlertControllerStyle.Alert)
                alert.addAction(UIAlertAction(title: "OK", style: UIAlertActionStyle.Default, handler: { Void in
                    self.dismissViewControllerAnimated(false, completion: nil)
                    self.postNotification("Backup created", obj: "Uploaded")
                }))
                ...
                self.presentViewController(alert, animated: true, completion: nil)
                    ...
                    default:
                        errorMessage = "Backup information is incorrect\(err)."
                        //errorMessage = "\(err)"
                    }
